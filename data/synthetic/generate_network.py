...
def generate_fatf_network(
    output_file: str = "data/synthetic/synthetic_network.json", seed: int = 42
) -> dict[str, Any]:
    """
    ...
    base_time = datetime.datetime(2026, 9, 10, 8, 0, 0, tzinfo=datetime.timezone.utc)
    ...
    entity_configs = [
        ...
        {
            "id": "ACC-SMURF-101",
            "name": "Apex Micro Holdings Ltd",
            "entity_type": "shell_company",
            "risk_rating": "high",
        },
        {
            "id": "ACC-SMURF-102",
            "name": "Vortex Trading FZE",
            "entity_type": "import_export",
            "risk_rating": "high",
        },
        {
            "id": "ACC-SMURF-103",
            "name": "Zenith General Trading",
            "entity_type": "retail",
            "risk_rating": "medium",
        },
        {
            "id": "ACC-SMURF-104",
            "name": "BlueSky Consulting DMCC",
            "entity_type": "consultancy",
            "risk_rating": "high",
        },
        {
            "id": "ACC-COLLECTOR-100",
            "name": "Grand Horizon Capital Partners",
            "entity_type": "holding_co",
            "risk_rating": "critical",
        },
        # Round-Tripping Cluster 1
        {
            "id": "ACC-RT-201",
            "name": "Silverline Logistics Pte",
            "entity_type": "logistics",
            "risk_rating": "high",
        },
        {
            "id": "ACC-RT-202",
            "name": "Offshore Conduit BVI Ltd",
            "entity_type": "shell_company",
            "risk_rating": "critical",
        },
        {
            "id": "ACC-RT-203",
            "name": "Meridian Trade Finance Corp",
            "entity_type": "trade_finance",
            "risk_rating": "high",
        },
        {
            "id": "ACC-RT-204",
            "name": "Global Equity Advisory Ltd",
        ...
        {
            "id": "ACC-LAYER-301",
            "name": "Originator Fund Escrow",
            "entity_type": "escrow",
            "risk_rating": "medium",
        },
        {
            "id": "ACC-LAYER-302",
            "name": "Hop-1 FastBridge Transit",
            "entity_type": "msb_payment",
            "risk_rating": "critical",
        },
        {
            "id": "ACC-LAYER-303",
            "name": "Hop-2 Continental Clearing",
            "entity_type": "intermediary",
            "risk_rating": "high",
        },
        {
            "id": "ACC-LAYER-304",
            "name": "Hop-3 Pacific Settle Inc",
            "entity_type": "intermediary",
            "risk_rating": "high",
        },
        {
            "id": "ACC-LAYER-305",
            "name": "Beneficiary Apex Assets LLC",
            "entity_type": "asset_holding",
            "risk_rating": "critical",
        },
        # Structuring Cluster 2
        {
            "id": "ACC-SMURF-401",
            "name": "Kite Global Suppliers",
            "entity_type": "retail",
            "risk_rating": "medium",
        },
        {
            "id": "ACC-SMURF-402",
            "name": "Nova Tech Consulting",
            "entity_type": "services",
            "risk_rating": "high",
        },
        {
            "id": "ACC-SMURF-403",
            "name": "Prime Wave Trading",
            "entity_type": "shell_company",
            "risk_rating": "high",
        },
        {
            "id": "ACC-COLLECTOR-400",
            "name": "Starlight Asset Management",
            "entity_type": "wealth_mgmt",
            "risk_rating": "critical",
        },
        # Round-Tripping Cluster 2
        {
            "id": "ACC-RT-501",
            "name": "Crown Infrastructure Group",
            "entity_type": "construction",
            "risk_rating": "high",
        },
        {
            "id": "ACC-RT-502",
            "name": "Seychelles Special Ventures",
            "entity_type": "offshore_spv",
            "risk_rating": "critical",
        },
        {
            "id": "ACC-RT-503",
            "name": "Lumina Capital Holdings",
            "entity_type": "holding_co",
            "risk_rating": "high",
        },
        ...
        {
            "id": "ACC-BENIGN-001",
            "name": "Metro Enterprise Payroll Desk",
            "entity_type": "corporate",
            "risk_rating": "low",
        },
        {
            "id": "ACC-BENIGN-002",
            "name": "National Utility Distribution",
            "entity_type": "utility",
            "risk_rating": "low",
        },
        {
            "id": "ACC-BENIGN-003",
            "name": "Sunrise Agro Supplies",
            "entity_type": "agriculture",
            "risk_rating": "low",
        },
        {
            "id": "ACC-BENIGN-004",
            "name": "TechCore Software Solutions",
            "entity_type": "it_services",
            "risk_rating": "low",
        },
        {
            "id": "ACC-BENIGN-005",
        ...
        {
            "id": "ACC-BENIGN-006",
            "name": "Reliance Industrial Parts",
            "entity_type": "manufacturing",
            "risk_rating": "low",
        },
        {
            "id": "ACC-BENIGN-007",
            "name": "Alpha Retail Superstores",
            "entity_type": "retail",
            "risk_rating": "low",
        },
        {
            "id": "ACC-BENIGN-008",
            "name": "Omni Logistics Fleet",
    ...
    for i, sender in enumerate(smurf_senders_1):
        ...
        tx_time = structuring_base_time + datetime.timedelta(
            hours=i * 2 + random.uniform(0.1, 1.2)
        )
    ...
    for i in range(len(rt_cycle_nodes) - 1):
        ...
        tx_time = rt_base_time + datetime.timedelta(
            hours=i * 8 + random.uniform(0.5, 2.0)
        )
        tid = f"TX-SYNTH-{tx_counter:04d}"
        tx_counter += 1
    ...
    for i in range(len(layer_chain_nodes) - 1):
        ...
        tx_time = layer_base_time + datetime.timedelta(
            minutes=i * 55 + random.randint(5, 20)
        )
        tid = f"TX-SYNTH-{tx_counter:04d}"
        tx_counter += 1
                ...
                edges.append(
                    {
                        ...
                        "timestamp": (
                            current_day
                            + datetime.timedelta(hours=9, minutes=random.randint(0, 50))
            ...
            edges.append(
                {
                    ...
                    "amount": amt,
                    "timestamp": (
                        current_day + datetime.timedelta(hours=hour, minutes=minute)
                    ).strftime("%Y-%m-%dT%H:%M:%SZ"),
    ...
    print(
        f"Generated synthetic FATF network with {len(nodes)} nodes, {len(edges)} transactions, and {len(ground_truth_flags)} seeded typologies -> {output_file}"
    )
